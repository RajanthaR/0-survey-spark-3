...
export const UI = {
  ...
  homeChooseSurvey: {
    en: "Choose where to begin",
    si: "ආරම්භ කරන තැන තෝරන්න",
    ta: "எங்கு தொடங்குவது எனத் தேர்ந்தெடுங்கள்",
  },
  homeChooseSurveyLead: {
    en: "Two questionnaires, one goal — pick the phase that matches your role.",
    si: "ප්‍රශ්නාවලි දෙකක්, එක ඉලක්කයක් — ඔබේ භූමිකාවට ගැළපෙන අදියර තෝරන්න.",
    ta: "இரண்டு கேள்வித்தாள்கள், ஒரே இலக்கு — உங்கள் பங்கிற்கு பொருந்தும் கட்டத்தைத் தேர்ந்தெடுங்கள்.",
  },
  skipToMain: {
