...
import { DashboardCharts } from "./admin/charts-lazy";
import { Card, CenteredCard, ChartFallback, Stat } from "./admin/primitives";
import {
  LineChartSkeleton,
  BarChartSkeleton,
  PieChartSkeleton,
...
import { computeDropoff } from "@/components/admin/dropoff-compute";
import { AlertsPanel } from "@/components/admin/AlertsPanel";
import {
  detectAlerts,
  type AdminAlert,
  type AlertSnapshot,
} from "@/components/admin/alerts/detect";
